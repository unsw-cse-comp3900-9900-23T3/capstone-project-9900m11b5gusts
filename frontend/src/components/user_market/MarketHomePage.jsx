    ...
    <Box sx={{ flex: 1, width: "100%" }} >
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center' }}>
        <Stack direction="row" spacing={2} style={{marginTop: '30px'}}>
          <SelectCategoryButton token={token} classes={classes} setClasses={setClasses} handleClearCategory={handleClearCategory} />
          <SearchBar token={token} classes={classes} setClasses={setClasses} handleClearCategory={handleClearCategory}/>
        </Stack>
