...
const urls = {
  ...
  searchActivity: baseUrl + "Activity/showArchivedActivity/",
  showActivity: baseUrl + "Activity/showArchivedActivity/",
...
export default function MainPage() {
  ...
  const searchActivity = async () => {
    ...
    const res = await fetch(urls.searchActivity + paginationObj.currentPage + "/" + paginationObj.pageSize, {
      method: 'POST',
